...
public class TallerPOO {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Persona p = new Persona(456161733, "Jaun", "Gonzales", new Date(5, 12, 2003 - 1900), "nuevo domicilio", 42355648, "+54 34500000", "Divorciado", "correo@mail.com");
//        Persona p = new Persona(45616133, "Deian", "Teze", new Date(5, 12, 2003 - 1900), "casa", 42355648, "+54 34500000", "Divorciado", "correo@mail.com");
