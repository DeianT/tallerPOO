...
public class RegistroFuncionario extends javax.swing.JFrame {
    ...
    public void listar() {
        ...
        //habilita la capacidad de ordenamiento de las filas en la tabla y permite q esta cree aut un rowsorter para el ordenamiento
        sorter = new TableRowSorter<>(modelo);//creo una instacnia de tablerowsortedy la asocio a un modelo de tabla
        jtFuncionarios.setRowSorter(sorter);//esta estableciendo el rowsorted osea el sorted a la tabla
    }
